    ...
    : BaseMailClient(parent)
{
    ...
    logInfo() << "MockMailClient instance created";
}

Result<QStringList> MockMailClient::fetchMailboxesImpl()
{
...
Result<quint64> MockMailClient::fetchLastMessageUID(const QString &mailbox)
{
